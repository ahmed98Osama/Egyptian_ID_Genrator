...
# Streamlit app
st.write("<h1><span style='color: red'>Egyptian</span><span style='color: white'> Valid</span> <span style='color: gold'> ID</span><span style='color: white'> Number</span><span style='color: #000000'> Generator .</span></h1>",
